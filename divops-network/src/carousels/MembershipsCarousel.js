...
function MembershipCarousel() {
  ...
  const [items] = useState([
    {
      quote: 'Incognito Token',
      year: 'Preview Mode',
      description: 'New to Divops?  Try it now.',
      Register: 'Signup',
      stripeLink: '#'
    },
    {
                ...
                {items.map((item, index) => (
                  ...
                  >
                    ...
                    <div className="font-medium text-lg">
                      ...
                      <span className="text-gray-500 dark:text-gray-400">{item.role}</span> <a className="text- hover:underline" href={item.link}>{item.description}</a>
                    </div>

      ...
      <div className="py-12 md:py-20">
        ...
        <div className="carousel swiper-container">
          <div className="swiper-wrapper">
            ...
            {/* Post 1 */}
            <CustomLink to="/season/1960" className="swiper-slide max-w-lg border border-teal-500  dark:focus:border-teal-500 dark:border-teal-500 hover:border-2 cursor-pointer">
              <Image className="transition-opacity duration-300" src={'/images/carousel-item-01.svg'} width="540" height="460" alt="Carousel item 01" />
            ...
            <CustomLink to="/season/1964" className="swiper-slide max-w-lg border border-teal-500 dark:focus:border-teal-500 dark:border-teal-500 hover:border-2 cursor-pointer">
              <Image className="transition-opacity duration-300" src={'/images/carousel-item-02.svg'} width="540" height="460" alt="Carousel item 02" />
              <div className="absolute inset-0 flex flex-col transition-opacity duration-300 translate-z-0">
                <div className="absolute bottom-0 right-0 p-6">
                  <br />
            ...
            <CustomLink to="/#post-coming-soon" className="swiper-slide max-w-lg border border-red-500 dark:focus:border-red-500 dark:border-red-500 hover:border-2 cursor-pointer">
              <Image className="transition-opacity duration-300" src={'/images/carousel-item-03.svg'} width="540" height="460" alt="Carousel item 03" />
              <div className="absolute inset-0 flex flex-col transition-opacity duration-300 translate-z-0">
                <div className="absolute bottom-0 right-0 p-6">
            ...
            <CustomLink to="/#post-coming-soon" className="swiper-slide max-w-lg border border-red-500 dark:focus:border-red-500 dark:border-red-500 hover:border-2 cursor-pointer">
              <Image className="transition-opacity duration-300" src={'/images/carousel-item-04.svg'} width="540" height="460" alt="Carousel item 04" />
              <div className="absolute inset-0 flex flex-col transition-opacity duration-300 translate-z-0">
                <div className="absolute bottom-0 right-0 p-6">
            ...
            <CustomLink to="/#post-coming-soon" className="swiper-slide max-w-lg border border-red-500 dark:focus:border-red-500 dark:border-red-500 hover:border-2 cursor-pointer">
              <Image className="transition-opacity duration-300" src={'/images/carousel-item-05.svg'} width="540" height="460" alt="Carousel item 05" />
              <div className="absolute inset-0 flex flex-col transition-opacity duration-300 translate-z-0">
                <div className="absolute bottom-0 right-0 p-6">
            ...
            <CustomLink to="/#post-coming-soon" className="swiper-slide max-w-lg border border-red-500 dark:focus:border-red-500 dark:border-red-500 hover:border-2 cursor-pointer">
              <Image className="transition-opacity duration-300" src={'/images/carousel-item-06.svg'} width="540" height="460" alt="Carousel item 06" />
              <div className="absolute inset-0 flex flex-col transition-opacity duration-300 translate-z-0">
                <div className="absolute bottom-0 right-0 p-6">
            ...
            <CustomLink to="/#post-coming-soon" className="swiper-slide max-w-lg border border-red-500 dark:focus:border-red-500 dark:border-red-500 hover:border-2 cursor-pointer">
              <Image className="transition-opacity duration-300" src={'/images/carousel-item-07.svg'} width="540" height="460" alt="Carousel item 07" />
              <div className="absolute inset-0 flex flex-col transition-opacity duration-300 translate-z-0">
                <div className="absolute bottom-0 right-0 p-6">

    ...
    <div className="mb-8">
      ...
      <ul className="-my-3">
        <li className="flex py-3 border-b border-gray-500 dark:border-gray-400">
          ...
          <article>
            <CustomLink className="hover:underline underline-green-500" to="/blog-post">
              <h3 className="font-red-hat-display font-bold tracking-tight mb-1 text-green-500">
                The First Summer
              </h3>
            </CustomLink>
            <div className="text-sm text-gray-500">
              By <CustomLink className="font-medium text-gray-500 dark:text-gray-400 hover:underline" href="/#/__/Johnny-Joe">Johnny Joe </CustomLink> <span className="text-green-500">Nov, 2nd 2021</span>
            </div>
          </article>
        </li>
        ...
        <li className="flex py-3 border-b border-gray-500 dark:border-gray-400">
          ...
          <span className="h4 w-12 font-red-hat-display text-gray-400 dark:text-gray-600 dark:hover:text-teal-500 flex-shrink-0 mt-0">️</span>
          <article>
            <CustomLink className="hover:underline" to="/blog-post">

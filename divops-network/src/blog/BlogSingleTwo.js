  ...
  return (
    <section className="relative">
      ...
      <div className="absolute inset-0 h-128 pt-16 box-content">
        <Image className="sticky inset-0 w-full h-full object-cover opacity-25" src='/images/notre-dame-network.jpg' width="1440" height="577" alt="About" />
            ...
            <article>
              ...
              <div className="text-lg text-gray-400 dark:text-gray-400" data-aos="fade-up" data-aos-delay="450">
                ...
                <figure className="mb-8">
                  <Image className="w-full" src={'/images/blog-post-2.jpg'} width="768" height="432" alt="News inner" />
                </figure>

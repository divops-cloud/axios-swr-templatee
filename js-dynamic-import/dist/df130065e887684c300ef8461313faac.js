...
function handleClick() {
  require("_bundle_loader")(require.resolve("./src/execCommand")).then(module => {
...
},{"_bundle_loader":3,"./src/execCommand":["8bfa12c3bf4d2933086bf8749397b538.js",4]}],0:[function(require,module,exports) {
...
if (!module.bundle.parent && typeof WebSocket !== 'undefined') {
  var ws = new WebSocket('ws://localhost:35693/');

        ...
        <div className="relative pt-4 sm:pt-6 pb-16 sm:pb-24">
          <Popover>
            <div className="max-w-7xl mx-auto px-4 sm:px-6">
              ...
              >
                ...
                <div className="hidden md:flex md:space-x-5 lg:space-x-10 hover:text-rose-300">
                  {NAVBAR_LINKS.map((item) => (
                    <a
                      key={item.name}
                      href={item.href}
                      className="font-medium text-gray-500 hover:text-rose-300"
                    >
                      {item.name}
                    </a>
                  ))}
          ...
          <div className="flex flex-row justify-center">
            <div className="text-center pt-14">
              ...
              <Image
                src="/serving-tokens-logo.svg"
                alt="Serving Tokens Logo"
                height={300}
                width={300}
              />
            </div>
